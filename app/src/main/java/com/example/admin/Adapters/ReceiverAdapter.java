 ...
 */
public class ReceiverAdapter extends ArrayAdapter<Debt> {
    ...
    public ReceiverAdapter(Context context, int resource, List<Debt> debtList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        holder.infos_debt_amount.setTextColor(Color.RED);
        return convertView;
